...
#include <zxing/datamatrix/decoder/_Decoder.h>
...
void _Decoder::correctErrors(ArrayRef<unsigned char> codewordBytes, int numDataCodewords) {
...
Ref<DecoderResult> _Decoder::decode(Ref<BitMatrix> bits) {
